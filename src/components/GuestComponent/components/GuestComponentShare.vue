<template>
  <div class="guest-component-share">
    <div class="ico">
      <img
    ...
    <div class="title">
      Напишите Диме в WhatsApp!
    </div>
    <div class="sub-title">
      Если у вас есть приложение "WhatsApp" на компьютере нажмите кнопку ниже
    </div>
    <div class="btn">
      <basic-button text="Отправить Сообщение" />
    </div>
    <div class="info">
      или отсканируйте <span>QR код</span>, чтобы написать с мобильного
      устройства
    </div>
    <div class="qr-code">
      <qrcode-vue
