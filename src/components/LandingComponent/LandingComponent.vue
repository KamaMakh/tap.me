  ...
  <div class="landing-component">
    ...
    <div class="footer">
      <div class="bottom-menu">
        <div class="menu-item">
          <a href="/files/policy.pdf">Политика конфиденциальности</a>
        </div>
        <div class="menu-item">
          <a href="/files/oferta.pdf">Оферта</a>
        </div>
        <div class="menu-item">
...
.landing-component {
  .sale-more {
    ...
    .pic-block {
      background: url("./assets/sale_bg.png") 0 0 no-repeat;
      width: 440px;
      height: 640px;
      @media all and(max-width: 1170px) {
        align-self: flex-end;
  ...
  .how-it-works {
    ...
    .first {
      ...
      .form {
        box-shadow: 0px 0px 109px rgba(0, 0, 0, 0.18);
        width: 372px;
        height: 398px;
    ...
    .third {
      ...
      .form {
        width: 425px;
        height: 650px;
        background: url("./assets/third_step.png") 0 0 no-repeat;
        position: relative;
        &:after {
          z-index: -1;
          content: "";
          ...
          right: -142px;
          left: auto;
          background: url("./assets/small_bg.png") 0 0 no-repeat;
        }
        @media all and(max-width: 1170px) {
          &:after {
            left: -45px;
  ...
  .opportunities {
    ...
    .first-list {
      ...
      .first {
        background: url("./assets/op_bg.png") 0 0 no-repeat;
        -webkit-background-size: cover;
        background-size: cover;
        box-shadow: 0 0 109px rgba(255, 166, 118, 0.36);
        &__top {
          width: 311px;
          max-width: 100%;
          height: 57px;
  ...
  .footer {
    ...
    .bottom-tg {
      ...
      margin-right: 100px;
      height: 47px;
      background: url("./assets/bot-tg.png") 0 0 no-repeat;
      @media all and(max-width: 1170px) {
        margin-right: 0;
      }
      @media all and(max-width: 755px) {
