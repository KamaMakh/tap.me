    ...
    <div class="my-card">
      ...
      <div class="bio">
        ...
        <div class="call-back">
          ...
          <div class="item first" @click="showSocial">
            <img
          ...
          <div class="item second" @click="showSocial">
            <img
          ...
          <div class="item third" @click="showSocial">
            <img
...
export default {
  ...
  methods: {
    ...
    showSocial() {
      alert("Тут будет переход по ссылке соц сети");
    }
  }
};
</script>
